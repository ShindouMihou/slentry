...
require (
	github.com/ShindouMihou/go-little-utils v0.0.3 // indirect
	github.com/ShindouMihou/korin v0.0.1-beta04 // indirect
	github.com/ShindouMihou/siopao v1.0.5 // indirect
